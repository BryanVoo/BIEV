...
<body>
    ...
    <!-- <div class=""> -->
        <div class="container">
            <div class="row">
            <h3><a href="home.html">Covid-19 Vaccine and Details</a></h3>
            </div>
        </div>
    </div>
        ...
        <main class="col-xl-9 order-xl-2">
            ...
            <div class="row">
                ...
                <div class="col content">
                    ...
                    <div class="row">
                        <br>
                        <h2 id="content" class="open d-lg-block">Register Form</h2>
                        <br>
                        <br>
                        <br>
                            ...
                            <div class="col-md-12">
                                <div class="card border-0 rounded-0 mb-3">
                                    <div class="card-body bg-primary">
                                        <div class="row">
                                            <div class="col">
                                                <h3 class="card-title h3 mb-3 text-left">Register vaccination</h3>
